...
class StreamingServer:
    ...
    def __client_connection(self, connection, address):
        ...
        # 모델 로드
        model = load_model("C:/Users/user/Desktop/thinkbox/thinkbox/faceCall_pj/lib/CNNmodel_v2_b8_srs_do.h5")
        # 얼굴 인식기 초기화 (OpenCV의 Haarcascades 이용)
        face_cascade = cv2.CascadeClassifier('C:/Users/user/Desktop/thinkbox/thinkbox/faceCall_pj/lib/haarcascade_frontalface_default.xml')
        # 자막 함수 파일 연동
        import sys
        sys.path.append('C:/Users/user/Desktop/thinkbox/thinkbox/faceCall_pj')
        ...
        while self.__running:
            ...
            cv2.rectangle(frame, (0, 430), (640, 480), (255, 0, 0), -1)
            # print korean subtitle
            cv2.putText(frame, "[KOR]:", (720, 980),
                        cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 0, 255), 10)
            # print translated subtitle
            cv2.putText(frame, "[ENG]:", (980, 720),
                        cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 0, 255), 10)
            cv2.putText(frame, my.Engtext, (100, 100),
                        cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 0, 255), 10)
            print(frame.shape)
